...
{
  real_T azPar_0;
  profileStart_NTCM_G(1U); /* original_line:57 */azPar_0 = sqrt(((((brdcIonoParam[1] * brdcIonoParam[1]) * 1633.33) +
                   (brdcIonoParam[0] * brdcIonoParam[0])) + ((brdcIonoParam[2] *
    brdcIonoParam[2]) * 4.802E+6)) + ((3266.67 * brdcIonoParam[0]) *
    brdcIonoParam[2]));profileEnd_NTCM_G(1U); /* original_line:60 */
  return azPar_0;
}
  ...
  *SolzenithTerm2)
{
  ...
  real_T phiGNP;
  profileStart_NTCM_G(2U); /* original_line:101 */cos_lat_delta = cos(IppPosRad[0] - Delta);profileEnd_NTCM_G(2U); /* original_line:101 */
  phiGNP = 0.017453292519943295 * Phys_Const[8];
  *SolzenithTerm1 = cos_lat_delta + Phys_Const[0];
  profileStart_NTCM_G(3U); /* original_line:104 */*SolzenithTerm2 = cos_lat_delta - ((IppPosRad[0] / 1.5707963267948966) * sin
    (Delta));profileEnd_NTCM_G(3U); /* original_line:105 */
  profileStart_NTCM_G(4U); /* original_line:106 */*LatmRad = (cos(IppPosRad[1] - (0.017453292519943295 * Phys_Const[9])) * (cos
    (IppPosRad[0]) * cos(phiGNP))) + (sin(IppPosRad[0]) * sin(phiGNP));profileEnd_NTCM_G(4U); /* original_line:107 */
  profileStart_NTCM_G(5U); /* original_line:108 */*LatmRad = asin(*LatmRad);profileEnd_NTCM_G(5U); /* original_line:108 */
}
  ...
  *exp_EC1, real_T *exp_EC2)
{
  ...
  *cosVd = (((*LT) - Phys_Const[1]) * 6.2831853071795862) / 24.0;
  profileStart_NTCM_G(6U); /* original_line:161 */*cosVd = cos(*cosVd);profileEnd_NTCM_G(6U); /* original_line:161 */
  *cosVsd = Vsd;
  profileStart_NTCM_G(7U); /* original_line:163 */*cosVsd = cos(*cosVsd);profileEnd_NTCM_G(7U); /* original_line:163 */
  *sinVsd = Vsd;
  profileStart_NTCM_G(8U); /* original_line:165 */*sinVsd = sin(*sinVsd);profileEnd_NTCM_G(8U); /* original_line:165 */
  *cosVtd = Vtd;
  profileStart_NTCM_G(9U); /* original_line:167 */*cosVtd = cos(*cosVtd);profileEnd_NTCM_G(9U); /* original_line:167 */
  *sinVtd = Vtd;
  profileStart_NTCM_G(10U); /* original_line:169 */*sinVtd = sin(*sinVtd);profileEnd_NTCM_G(10U); /* original_line:169 */
  Vsd = 57.295779513082323 * latm_rad;
  Vtd = Vsd - Phys_Const[4];
  Vsd -= Phys_Const[5];
  *exp_EC1 = ((-(Vtd * Vtd)) / 2.0) / (Phys_Const[6] * Phys_Const[6]);
  profileStart_NTCM_G(11U); /* original_line:174 */*exp_EC1 = exp(*exp_EC1);profileEnd_NTCM_G(11U); /* original_line:174 */
  *exp_EC2 = ((-(Vsd * Vsd)) / 2.0) / (Phys_Const[7] * Phys_Const[7]);
  profileStart_NTCM_G(12U); /* original_line:176 */*exp_EC2 = exp(*exp_EC2);profileEnd_NTCM_G(12U); /* original_line:176 */
}
  ...
  *F4, real_T *F5)
{
  *F1 = ((((((NTCM_Coeff_Vect[0] * cosVd) + (NTCM_Coeff_Vect[1] * cosVsd)) +
  ...
  profileStart_NTCM_G(13U); /* original_line:235 */*F2 = ((NTCM_Coeff_Vect[5] * cos(Va)) + 1.0) + (NTCM_Coeff_Vect[6] * cos(Vsa));profileEnd_NTCM_G(13U); /* original_line:235 */
  profileStart_NTCM_G(14U); /* original_line:236 */*F3 = (NTCM_Coeff_Vect[7] * cos(LatmRad)) + 1.0;profileEnd_NTCM_G(14U); /* original_line:236 */
...
{
  real_T delta_0;
  profileStart_NTCM_G(15U); /* original_line:265 */delta_0 = ((sin(((((*doy) - 80.7) * 0.9856) * 3.1415926535897931) / 180.0) *
              23.44) * 3.1415926535897931) / 180.0;profileEnd_NTCM_G(15U); /* original_line:266 */
  return delta_0;
}
            ...
            real_T NTCM_Phys_Cons[10], real_T *vTEC)
{
   ...
   */
  profileStart_NTCM_G(16U); /* original_line:325 */lOut_azPar = Compute_AzPar_Eq_2(brdcIonoParam);profileEnd_NTCM_G(16U); /* original_line:325 */
   ...
   */
  profileStart_NTCM_G(17U); /* original_line:341 */lOut_delta = Sun_declination_Eq_28(doy);profileEnd_NTCM_G(17U); /* original_line:341 */
   ...
   *     @ingroup NTCM_G
   */
  profileStart_NTCM_G(18U); /* original_line:360 */Compute_Eq_29_30_31(lOut_delta, IppCoord, NTCM_Phys_Cons, &lOut_LatmRad,
                      &lOut_SolzenithTerm1, &lOut_SolzenithTerm2);profileEnd_NTCM_G(18U); /* original_line:361 */
   ...
   */
  profileStart_NTCM_G(19U); /* original_line:381 */Compute_Eq_5_6_7_9_10_13_14(doy, LT, lOut_LatmRad, NTCM_Phys_Cons, &lOut_Va,
    &lOut_Vsa, &lOut_cosVd, &lOut_cosVsd, &lOut_sinVsd, &lOut_cosVtd,
    &lOut_sinVtd, &lOut_exp_EC1, &lOut_exp_EC2);profileEnd_NTCM_G(19U); /* original_line:383 */
   ...
   */
  profileStart_NTCM_G(20U); /* original_line:406 */Compute_F_factors(lOut_azPar, lOut_LatmRad, lOut_SolzenithTerm1,
                    ...
                    &lOut_F2, &lOut_F3, &lOut_F4, &lOut_F5);profileEnd_NTCM_G(20U); /* original_line:410 */

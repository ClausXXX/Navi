...
#ifndef RTW_HEADER_Compute_sTEC_h_
#define RTW_HEADER_Compute_sTEC_h_
#include <math.h>
...
extern real_T Compute_sTEC(real_T ele_rad, real_T vTEC);

#endif                                 /* RTW_HEADER_Compute_sTEC_h_ */

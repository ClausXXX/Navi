...
#ifndef RTW_HEADER_llh2xyz_Rec_h_
#define RTW_HEADER_llh2xyz_Rec_h_
...
extern void llh2xyz_Rec(const real_T llh[3], real_T xyz[3]);

#endif                                 /* RTW_HEADER_llh2xyz_Rec_h_ */

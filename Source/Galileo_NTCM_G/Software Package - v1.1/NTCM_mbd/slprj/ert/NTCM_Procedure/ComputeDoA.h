...
#ifndef RTW_HEADER_ComputeDoA_h_
#define RTW_HEADER_ComputeDoA_h_
#include <math.h>
...
extern void ComputeDoA(const real_T losVec[3], const real_T llhUserRad[3],
  real_T *SvDoAEleRad, real_T *SvDoAAzRad);

#endif                                 /* RTW_HEADER_ComputeDoA_h_ */

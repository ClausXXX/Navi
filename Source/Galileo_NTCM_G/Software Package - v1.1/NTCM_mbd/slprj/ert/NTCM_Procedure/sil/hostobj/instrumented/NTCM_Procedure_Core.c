  ...
  *vTEC, real_T *sTEC, real_T *delay_m, uint16_T *ErrorCode)
{
   ...
   *     @file
   */
  profileStart_NTCM_Procedure(16U); /* original_line:156 */llh2xyz_Rec(lOut_llhRad_a, lOut_xyz_i);profileEnd_NTCM_Procedure(16U); /* original_line:156 */
   ...
   *     @file
   */
  profileStart_NTCM_Procedure(17U); /* original_line:172 */llh2xyz_Sat(lOut_llhRad, lOut_xyz);profileEnd_NTCM_Procedure(17U); /* original_line:172 */
   ...
   *  @file
   */
  profileStart_NTCM_Procedure(18U); /* original_line:192 */ComputeDoA(lOut_losVec, lOut_llhRad_a, &lOut_SvDoAEleRad_, &lOut_SvDoAAzRad_);profileEnd_NTCM_Procedure(18U); /* original_line:192 */
   ...
   */
  profileStart_NTCM_Procedure(19U); /* original_line:207 */ElevetionCheck(lOut_SvDoAEleRad_, &lOut_El_check_out_, ErrorCode);profileEnd_NTCM_Procedure(19U); /* original_line:207 */
   ...
   *  @file
   */
  profileStart_NTCM_Procedure(20U); /* original_line:225 */getIonoPiercePoint(lOut_llhRad_a, lOut_El_check_out_, lOut_SvDoAAzRad_,
                     lOut_IppCoord_);profileEnd_NTCM_Procedure(20U); /* original_line:226 */
   ...
   *  @file
   */
  profileStart_NTCM_Procedure(21U); /* original_line:241 */lOut_LT = ComputeLocalTime(lOut_IppCoord_, UTC);profileEnd_NTCM_Procedure(21U); /* original_line:241 */
   ...
   *  @file
   */
  profileStart_NTCM_Procedure(22U); /* original_line:303 */NTCM_G(&brdcIonoParam[0], &Doy, &lOut_LT, &lOut_IppCoord_[0],
         &lOut_NTCM_Coeff_[0], &lOut_Physiscal_Const_[0], vTEC);profileEnd_NTCM_Procedure(22U); /* original_line:304 */
   ...
   *  @file
   */
  profileStart_NTCM_Procedure(23U); /* original_line:320 */*sTEC = Compute_sTEC(lOut_El_check_out_, *vTEC);profileEnd_NTCM_Procedure(23U); /* original_line:320 */
   ...
   */
  profileStart_NTCM_Procedure(24U); /* original_line:336 */*delay_m = Compute_IonoDelay(*sTEC, fcarr);profileEnd_NTCM_Procedure(24U); /* original_line:336 */
}

...
#ifndef RTW_HEADER_llh2xyz_h_
#define RTW_HEADER_llh2xyz_h_
#include <math.h>
...
extern void llh2xyz(const real_T llh[3], real_T xyz[3]);

#endif                                 /* RTW_HEADER_llh2xyz_h_ */

...
## Generated on : Tue Apr 26 10:03:52 2022
## Final product: ./NTCM_Procedure.exe
...
DEFINES_OPTS = -DTID01EQ=0 -DPORTABLE_WORDSIZES -DXIL_SIGNAL_HANDLER=1 -DCODER_ASSUMPTIONS_ENABLED=1 -DRTIOSTREAM_RX_BUFFER_BYTE_SIZE=50000 -DRTIOSTREAM_TX_BUFFER_BYTE_SIZE=50000 -DCODE_INSTRUMENTATION_ENABLED=1 -DMEM_UNIT_BYTES=1 -DMemUnit_T=uint8_T
...
SRCS = $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xil_interface_lib.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xil_data_stream.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xil_services.c $(START_DIR)/slprj/ert/NTCM_Procedure/sil/xil_interface.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xilcomms_rtiostream.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/xil_rtiostream.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_app.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_data_stream.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/coder_assumptions_rtiostream.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/sil_main.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/target_io.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(START_DIR)/slprj/ert/NTCM_Procedure/sil/xil_instrumentation.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/codeinstr_data_stream.c $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/codeinstr_rtiostream.c $(MATLAB_ROOT)/toolbox/coder/profile/src/host_timer_x86.c
...
OBJS = xil_interface_lib.obj xil_data_stream.obj xil_services.obj xil_interface.obj xilcomms_rtiostream.obj xil_rtiostream.obj rtiostream_utils.obj coder_assumptions_app.obj coder_assumptions_data_stream.obj coder_assumptions_rtiostream.obj sil_main.obj target_io.obj rtiostream_tcpip.obj xil_instrumentation.obj codeinstr_data_stream.obj codeinstr_rtiostream.obj host_timer_x86.obj
...
MODELREF_LIBS = C:/Users/zurnmar/Documents/2_SW_Devops/Prova+21042022/NTCM_mbd/slprj/ert/NTCM_Procedure/sil/hostobj/instrumented/NTCM_Procedure_rtwlib.lib C:/Users/zurnmar/Documents/2_SW_Devops/Prova+21042022/NTCM_mbd/slprj/ert/NTCM_G/sil/hostobj/instrumented/NTCM_G_rtwlib.lib

LIBS = $(START_DIR)/slprj/ert/_sharedutils/sil/hostobj/instrumented/rtwshared.lib $(START_DIR)/slprj/ert/NTCM_Procedure/coderassumptions/pwslib/NTCM_Procedure_ca.lib
...
%.obj : $(MATLAB_ROOT)/toolbox/coder/profile/src/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(MATLAB_ROOT)/toolbox/coder/profile/src/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
xil_interface.obj : $(START_DIR)/slprj/ert/NTCM_Procedure/sil/xil_interface.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
xil_instrumentation.obj : $(START_DIR)/slprj/ert/NTCM_Procedure/sil/xil_instrumentation.c
	$(CC) $(CFLAGS) -o "$@" "$<"


codeinstr_data_stream.obj : $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/codeinstr_data_stream.c
	$(CC) $(CFLAGS) -o "$@" "$<"


codeinstr_rtiostream.obj : $(MATLAB_ROOT)/toolbox/rtw/targets/pil/c/codeinstr_rtiostream.c
	$(CC) $(CFLAGS) -o "$@" "$<"


host_timer_x86.obj : $(MATLAB_ROOT)/toolbox/coder/profile/src/host_timer_x86.c
	$(CC) $(CFLAGS) -o "$@" "$<"

 ...
 * ******************************************************************
 * llh2xyz_Sat
 * Output and update for atomic system: '<S4>/llh2xyz2'
 * ******************************************************************
 ...
 * ******************************************************************
 */
void llh2xyz_Sat(const real_T llh[3], real_T xyz[3])
{
  /*
   * Block description for '<S31>/llh2xyz':
   *     <strong> FUNCTION </strong>
   ...
   *  @file
   */
  profileStart_NTCM_Procedure(35U); /* original_line:77 */llh2xyz(llh, xyz);profileEnd_NTCM_Procedure(35U); /* original_line:77 */
}

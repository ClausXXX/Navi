...
real_T Compute_sTEC(real_T ele_rad, real_T vTEC)
{
  real_T sTEC_0;
  real_T a;
  profileStart_NTCM_Procedure(9U); /* original_line:64 */a = sin((1.5707963267948966 - ele_rad) * 0.9782) * 0.934027268728925;profileEnd_NTCM_Procedure(9U); /* original_line:64 */
  profileStart_NTCM_Procedure(10U); /* original_line:65 */sTEC_0 = (1.0 / sqrt(1.0 - (a * a))) * vTEC;profileEnd_NTCM_Procedure(10U); /* original_line:65 */
  return sTEC_0;
}

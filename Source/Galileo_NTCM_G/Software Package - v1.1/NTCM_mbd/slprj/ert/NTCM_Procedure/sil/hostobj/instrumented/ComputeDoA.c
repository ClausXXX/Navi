                ...
                *SvDoAEleRad, real_T *SvDoAAzRad)
{
  ...
  real_T sinphi;
  int32_T i;
  profileStart_NTCM_Procedure(2U); /* original_line:73 */sinphi = sin(llhUserRad[0]);profileEnd_NTCM_Procedure(2U); /* original_line:73 */
  profileStart_NTCM_Procedure(3U); /* original_line:74 */cosphi = cos(llhUserRad[0]);profileEnd_NTCM_Procedure(3U); /* original_line:74 */
  profileStart_NTCM_Procedure(4U); /* original_line:75 */sinlam = sin(llhUserRad[1]);profileEnd_NTCM_Procedure(4U); /* original_line:75 */
  profileStart_NTCM_Procedure(5U); /* original_line:76 */coslam = cos(llhUserRad[1]);profileEnd_NTCM_Procedure(5U); /* original_line:76 */
  ...
  profileStart_NTCM_Procedure(6U); /* original_line:91 */sinphi = atan2(dV_rot[1], dV_rot[0]);profileEnd_NTCM_Procedure(6U); /* original_line:91 */
  if (sinphi <= 0.0) {
  ...
  profileStart_NTCM_Procedure(7U); /* original_line:98 */*SvDoAEleRad = (0.5 - (atan2(sqrt((dV_rot[0] * dV_rot[0]) + (dV_rot[1] *
    dV_rot[1])), dV_rot[2]) / 3.1415926535897931)) * 3.1415926535897931;profileEnd_NTCM_Procedure(7U); /* original_line:99 */
}

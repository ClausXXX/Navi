/*
 * NTCM_Procedure_ssf.c
 *
 * Automatically generated s-function with I/O interface for:
 * Component: NTCM_Procedure
 * Component Simulink Path: NTCM_Procedure
 * Simulation Mode: SIL
 *
 */

#define S_FUNCTION_NAME                NTCM_Procedure_ssf
...
static RegMdlInfo rtMdlInfo_NTCM_Procedure[1] = { "",
  ...
  memUnitSizeBytes)
{
  ...
  pCodeInstrServiceData->infoPath =
    "C:/Users/zurnmar/Documents/2_SW_Devops/Prova+21042022/NTCM_mbd/slprj/ert/NTCM_Procedure/sil";
...
static boolean_T startAndSetupApplication(SimStruct *S)
{
...

  {
    ...
    {
      mxArray * codeGenComponent = mxCreateString("NTCM_Procedure");
      mxArray *rhs[3];
      char * simulinkBlockPath = getSimulinkBlockPath(S);
      if (simulinkBlockPath == NULL) {
        ssSetErrorStatus(S,
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  slmrInitializeIOPortDataVectors(S, 6, 4);
  ...
  ssSetInputPortSampleTime(S, 1, 1.0);
  ...
  ssSetInputPortSampleTime(S, 2, 1.0);
  ...
  ssSetInputPortSampleTime(S, 3, 1.0);
  ssSetInputPortOffsetTime(S, 3, 0.0);
  if (!ssSetInputPortMatrixDimensions(S, 4, 3, 1))
    return;
  ...
  ssSetInputPortSampleTime(S, 4, 1.0);
  ...
  ssSetInputPortSampleTime(S, 5, 1.0);
  ...
  ssSetOutputPortSampleTime(S, 1, 1.0);
  ...
  ssSetOutputPortSampleTime(S, 2, 1.0);
  ...
  if (!ssSetOutputPortVectorDimension(S, 3, 16))
    return;
  ...
  ssSetOutputPortSampleTime(S, 3, 1.0);
  ...
  ssRegisterMsgForNotSupportingMultiExecInst(S,
    "<diag_root><diag id=\"Simulink:blocks:ImplicitIterSS_SignalViewNotSupportedInside\" pr=\"d\"><arguments><arg type=\"numeric\">7</arg><arg type=\"encoded\">TgBUAEMATQBfAFAAcgBvAGMAZQBkAHUAcgBlAC8AQwBoAGUAawBJAG4AcAB1AHQAAAA=</arg><arg type=\"encoded\">PABfAF8AaQBpAFMAUwBfAF8APgA8AC8AXwBfAGkAaQBTAFMAXwBfAD4AAAA=</arg><arg type=\"encoded\">PABfAF8AaQB0AGUAcgBCAGwAawBfAF8APgA8AC8AXwBfAGkAdABlAHIAQgBsAGsAXwBfAD4AAAA=</arg></arguments><hs><h>AAAAgAGgckBb</h></hs></diag></diag_root>");
  ...
  if (S->mdlInfo->genericFcn != (NULL) &&
    ...
    ssRegModelRefMdlInfo(S, "NTCM_Procedure", rtMdlInfo_NTCM_Procedure, 0);
  }
...
static void XILoutputTID01(SimStruct *S, int tid)
{
...

  {
    ...
    if (IOBufferPtr != NULL) {
      void * pXILService = (void *) ssGetPWorkValue(S, 9);
      if (pXILService != NULL) {
        if (xilHostAppSvcGrowIOBuffer(pXILService, IOBufferPtr, 105, 0)!=
            XILHOSTAPPSVC_SUCCESS) {
          return;
        }                              /* if */
  ...
  {
    {
      ...
      /* dispatch command to the target */
      if (commandDispatch(S, IOBufferPtr, 105)!=XILHOSTAPPSVC_SUCCESS) {
        return;
      }                                /* if */

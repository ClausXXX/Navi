  ...
  real_T IppCoord[2])
{
  real_T Psi_pp;
  real_T sinPsi_pp;
  profileStart_NTCM_Procedure(25U); /* original_line:69 */Psi_pp = (1.5707963267948966 - ElRad) - asin((Re / (IPP_RefAltitude + Re)) *
    cos(ElRad));profileEnd_NTCM_Procedure(25U); /* original_line:70 */
  profileStart_NTCM_Procedure(26U); /* original_line:71 */sinPsi_pp = sin(Psi_pp);profileEnd_NTCM_Procedure(26U); /* original_line:71 */
  profileStart_NTCM_Procedure(27U); /* original_line:72 */Psi_pp = asin(((cos(llhUserRad[0]) * sinPsi_pp) * cos(AzRad)) + (sin
    (llhUserRad[0]) * cos(Psi_pp)));profileEnd_NTCM_Procedure(27U); /* original_line:73 */
  IppCoord[0] = Psi_pp;
  profileStart_NTCM_Procedure(28U); /* original_line:75 */IppCoord[1] = asin((sinPsi_pp * sin(AzRad)) / cos(Psi_pp)) + llhUserRad[1];profileEnd_NTCM_Procedure(28U); /* original_line:75 */
}

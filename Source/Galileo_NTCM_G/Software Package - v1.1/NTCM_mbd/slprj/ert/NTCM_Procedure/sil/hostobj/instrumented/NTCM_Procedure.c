                    ...
                    *sTEC, real_T *delay_m, uint16_T ErrorCode[16])
{
   ...
   *
   */
  profileStart_NTCM_Procedure(12U); /* original_line:117 */ChekInput(brdcIonoParam, Doy, UTC, llhRecDeg, llhSatDeg, fcarr,
            lOut_brdcIonoParam_, &lOut_Doy_, &lOut_UTC_, lOut_llhRecDeg_,
            lOut_llhSatDeg_, &lOut_fcarr_, lOut_ErrorCodeIn_);profileEnd_NTCM_Procedure(12U); /* original_line:119 */
   ...
   *  @file
   */
  profileStart_NTCM_Procedure(13U); /* original_line:191 */NTCM_Procedure_Core(lOut_brdcIonoParam_, lOut_Doy_, lOut_UTC_, lOut_llhRecDeg_,
                      lOut_llhSatDeg_, lOut_fcarr_, &lOut_NTCM_G, &lOut_sTEC_,
                      &lOut_delay_m1__d, &lOut_El_ErrCOde_);profileEnd_NTCM_Procedure(13U); /* original_line:193 */
   ...
   */
  profileStart_NTCM_Procedure(14U); /* original_line:218 */CheckOutput(lOut_NTCM_G, lOut_sTEC_, lOut_delay_m1__d, vTEC, sTEC, delay_m,
              lOut_ErrorCodeOut_);profileEnd_NTCM_Procedure(14U); /* original_line:219 */
   ...
   */
  profileStart_NTCM_Procedure(15U); /* original_line:239 */ErrorMnG(lOut_ErrorCodeOut_, lOut_El_ErrCOde_, lOut_ErrorCodeIn_, ErrorCode,
           &NTCM_Procedure_P.ErrorMnG_i);profileEnd_NTCM_Procedure(15U); /* original_line:240 */
}

                 ...
                 *sTEC1, real_T *delay_m1, uint16_T ErrorCode[3])
{
  ...
  profileStart_NTCM_Procedure(1U); /* original_line:175 */NTCM_Procedure_n(lOut_TmpSignalConversionAtSatur, lOut_CheckOut, lOut_AND);profileEnd_NTCM_Procedure(1U); /* original_line:175 */

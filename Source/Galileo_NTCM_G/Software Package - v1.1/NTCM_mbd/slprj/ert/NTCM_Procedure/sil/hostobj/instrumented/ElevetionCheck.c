                    ...
                    *El_ErrCOde)
{
   ...
   */
  profileStart_NTCM_Procedure(11U); /* original_line:123 */NTCM_Procedure_e(El_check_in, &lOut_VariantMergeForOutportEl_c, &lOut_AND);profileEnd_NTCM_Procedure(11U); /* original_line:123 */
  if (lOut_AND) {

function cs = NTCM_TEST_HARNESS_Conf_Param()
% MATLAB function for configuration set generated on 10-Mar-2022 10:52:00
...
cs.set_param('StopTime', 'SM.INI.End_Time');   % Stop time
...
cs.set_param('FixedStep', 'SM.INI.Sample_Time');   % Fixed-step size (fundamental sample time)
...
cs.set_param('MaxIdLength', 51);   % Maximum identifier length
...
cs.set_param('ERTDataHdrFileTemplate', 'Myert_code_template.cgt');   % Header file template
cs.set_param('ERTDataSrcFileTemplate', 'Myert_code_template.cgt');   % Source file template
cs.set_param('RateTransitionBlockCode', 'Inline');   % Rate Transition block code
cs.set_param('ERTHdrFileBannerTemplate', 'Myert_code_template.cgt');   % Header file template
cs.set_param('ERTSrcFileBannerTemplate', 'Myert_code_template.cgt');   % Source file template

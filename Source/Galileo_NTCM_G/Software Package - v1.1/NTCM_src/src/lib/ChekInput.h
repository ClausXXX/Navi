...
#ifndef RTW_HEADER_ChekInput_h_
#define RTW_HEADER_ChekInput_h_
...
extern void ChekInput(const real_T AzParam[3], const real_T *Doy, const real_T
                      *UTC, const real_T llhRecDeg[3], const real_T llhSatDeg[3],
                      const real_T *fcarr, real_T brdcIonoParam[3], real_T *Doy1,
                      real_T *UTC1, real_T llhRecDeg1[3], real_T llhSatDeg1[3],
                      real_T *fcarr1, uint16_T ErrorCode[12]);

#endif                                 /* RTW_HEADER_ChekInput_h_ */
